                    ...
                    <div class="col-md-11 p-4">
                        <div class="owl-carousel owl-theme ">
                            <div class="item p-2">
                                ...
                                <div class="card border-0 box-area">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 d-flex justify-content-end">
                                            <div class="alarm-image">
                                                <img src="alarm.png" class="img-responsive" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row d-flex justify-content-center align-items-center">
                                        <div class="col-md-6 col-sm-8 col-xs-8">
                                            <div class="img-responsive">
                                                <img src="ad-img.png" class="img-responsive" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="card-body text-center">
                                                <!--<i class="fa-solid fa-medal" style="font-size: 3rem;"></i>-->
                                                <div class="row d-flex justify-content-center align-items-center">
                                                    <img src="gold.png" alt="platinum" class="rounded float-start img-fluid package-icon"/>
                                                    <small class="text-warning" style="font-size: 20px; font-weight: bold; letter-spacing: 2px;">Gold Pack</small>
                                                </div>
                                                
                                                <h5 class="card-title">₦100,000</h5>
                                                <p class="card-text">Get a 10% interest upon any amount invested at the end of 30days</p>
                                                <a href="#" class="btn btn-info invest-btn">Invest Now</a>
                                            </div>
                                        </div>
                                    </div>
                              </div>
                                ...
                                <div class="row d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body text-center">
                                                 <!--<i class="fa-solid fa-medal" style="font-size: 3rem;"></i>-->
                                                 <div class="row d-flex justify-content-center align-items-center">
                                                    <img src="bronz.png" alt="platinum" class="rounded float-start img-fluid package-icon"/>
                                                    <small class="text-warning" style="font-size: 20px; font-weight: bold; letter-spacing: 2px;">Bronze Pack</small>
                                                </div>
...
<!--                                                 <i class="fa-solid fa-medal" style="font-size: 3rem;"></i>-->
                                                <div class="row d-flex justify-content-center align-items-center">
                                                    <img src="platinum.png" alt="platinum" class="rounded float-start img-fluid package-icon"/>
                                                    <small class="text-warning" style="font-size: 20px; font-weight: bold; letter-spacing: 2px;">Platinum Pack</small>
                                                </div>
